  ...
  async function submit(e: React.FormEvent) {
    ...
    try {
      if (mode === 'signup') {
        ...
        // Check for plan in URL and redirect to checkout
            ...
            <AnimatePresence mode="wait">
              {(success || error) && (
                <motion.div
                  ...
                  className={`mb-5 rounded-xl px-4 py-3 text-sm ${success
              ...
              {mode === 'signup' && (
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-parchment-100 border border-parchment-300 rounded-lg px-4 py-2.5 text-sm text-gray-900 input-ring placeholder-gray-400"
                  />
                </div>
              )}
              <div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      minLength={8}
                      className="w-full bg-parchment-100 border border-parchment-300 rounded-lg px-4 py-2.5 text-sm text-gray-900 input-ring placeholder-gray-400 pr-10"
                    />
