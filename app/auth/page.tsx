    ...
    <div style={{ minHeight: '100vh', display: 'flex', fontFamily: 'var(--font-sans)' }}>
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '48px 24px', background: '#f9fafb' }}>
        <div style={{ width: '100%', maxWidth: 420 }}>
          <Link href="/" className="lg:hidden" style={{ display: 'flex', alignItems: 'baseline', gap: 8, textDecoration: 'none', marginBottom: 32 }}>
            <span style={{ fontFamily: 'var(--font-serif)', fontSize: 22, fontWeight: 700, color: '#111827' }}>Folio</span>
            <span style={{ fontSize: 9, fontWeight: 800, letterSpacing: '0.18em', color: '#16a34a', textTransform: 'uppercase' }}>CV Builder</span>
          </Link>
